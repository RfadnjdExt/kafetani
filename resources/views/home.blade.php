...
<body>
    ...
    <section class="hero">
        <div style="position:relative; max-width:700px;">
            <span class="hero-badge">🌿 Langsung dari kebun</span>
            ...
            <div class="hero-btns">
                <a href="{{ route('menu.index') }}" class="btn-hero-primary">Lihat Menu Kafe</a>
                <a href="{{ route('marketplace.index') }}" class="btn-hero-outline">Marketplace Petani</a>
            </div>
        </div>
    </section>
