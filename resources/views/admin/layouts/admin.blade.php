...
<div class="admin-layout">
  <aside class="admin-sidebar">
    ...
    <nav class="admin-nav">
      ...
      <a href="{{ route('admin.farmers.index') }}"  class="{{ request()->routeIs('admin.farmers*')  ? 'active' : '' }}">👨‍🌾 Petani</a>
      <a href="{{ route('admin.orders.index') }}"   class="{{ request()->routeIs('admin.orders*')   ? 'active' : '' }}">📋 Pesanan</a>
      <a href="{{ route('admin.kasir') }}"          class="{{ request()->routeIs('admin.kasir*')    ? 'active' : '' }}">🖥 Kasir POS</a>
      <hr>
